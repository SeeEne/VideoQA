...
parser.add_argument('--config_file', type=str, default='config_probe.yaml',
...
try:
    ...
    NUM_WORKERS = int(probe_config.get('NUM_WORKERS', 0)) # For loading embeddings
...
if __name__ == "__main__":
    ...
    for epoch in range(EPOCHS):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save({ "/* ... state ... */" }, checkpoint_path) # Add details
